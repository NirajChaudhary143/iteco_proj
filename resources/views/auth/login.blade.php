...
<head>
  ...
  <link rel="icon" type="image/png" href="images/title_logo.jpg">
  <title>
    Sign In
  </title>
  ...
  <main class="main-content    mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('https://images.unsplash.com/photo-1497294815431-9365093b7331?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80');">
      ...
      <div class="container my-auto">
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto opacity-9">
              ...
              <div class="card-body">
                ...
                @enderror
                  ...
                  <div class="mt-0 text-center">
                    {{-- <input type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" value="Sign In"> --}}
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                made by
                <span class="font-weight-bold text-white">Anil Subedi</a>
                for a better web.
              </div>
            </div>
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                ...
                <li class="nav-item">
                  <a href="{{route('contact.us')}}" class="nav-link text-white" target="_blank">Contact Us</a>
                </li>
                <li class="nav-item">
