    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-12 mx-auto opacity-9">
        <div class="card z-index-0 ">
          ...
          <div class="card-body">
            <form  class="text-start row" action="{{route('update.project',['id'=>$project->id])}}" method="post"  enctype="multipart/form-data">
                @csrf
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 form-inp mb-3">
                  ...
                  <input type="text" class="" placeholder="" name="projectName" value="{{$project->project_title}}">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 form-inp mb-3">
                  <label class="form-label" for="pname" id="email">Client</label>
                  <input type="text" class="" placeholder="" name="client" value="{{$project->client_name}}">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 form-inp mb-3">
                  <label class="form-label" for="pname" id="email">UV / Association</label>
                  <input type="text" class="" placeholder="" name="uv" value="{{$project->uv_association}}">
              </div>

              <div class="col-lg-4 col-md-6 col-sm-12 form-inp mb-3">
                  <label class="form-label" for="startdate" id="email">Start Date</label>
                  <input type="date" name="startingDate" id="date" value="{{$project->start_date}}" />
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 form-inp mb-3">
                  <label class="form-label" for="completedate" id="email">Completed Date</label>
                  <input type="date" id="date" name="completionDate" value="{{$project->complete_date}}" />
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 form-inp mb-3">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 form-inp mb-3">
                ...
                <textarea name="description" cols="30" rows="5" id="projectDesc">{{$project->description}}</textarea>
            </div>
